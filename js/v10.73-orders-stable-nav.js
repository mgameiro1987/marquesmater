...
(()=>{
'use strict';
if(window.__MM_ORDERS_STABLE_NAV)return;window.__MM_ORDERS_STABLE_NAV=true;
function cleanupOverlays(){document.querySelectorAll('body > .mm72.modal,body > .mm104.modal,body > .mm75-modal,body > .mm34-modal').forEach(x=>x.remove());document.documentElement.classList.remove('mm64-mobile-view');document.body.classList.remove('modal-open','no-scroll','overflow-hidden')}
