...
window.MM104={go:k=>{if(k==='dashboard')dashboard();else prepared(k,k)}};
// O router legado não regista cliques nos menus. Produtos, Variantes e os restantes módulos são donos da sua própria navegação.
})();