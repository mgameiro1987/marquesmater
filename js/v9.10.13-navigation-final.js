...
let n=0;(function boot(){install();installGo();if((!document.querySelector('.sidebar nav')||!window.MMAdmin?.go)&&n++<120)setTimeout(boot,100);else if(n++<120)setTimeout(()=>{installGo()},250)})();
